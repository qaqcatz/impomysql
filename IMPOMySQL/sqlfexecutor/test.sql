...
');
SELECT * FROM table_10_utf8_4 AS t1 JOIN table_10_utf8_undef AS t2 ON t1. `col_double_undef_signed` + t2. `col_float_undef_unsigned`;
SELECT `col_double_key_signed` FROM table_30_latin1_4 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_binary_6 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_binary_4 WHERE  CONVERT(`col_char(20)_key_signed`, DATETIME);
SELECT * FROM table_10_binary_undef AS t1 JOIN table_10_utf8_4 AS t2 ON t1. `col_float_undef_unsigned` + t2. `col_double_undef_unsigned`;
SELECT `col_double_key_signed` FROM table_10_latin1_6 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_utf8_undef AS t1 JOIN table_30_binary_undef AS t2 ON t1. `col_char(20)_undef_signed` / t2. `col_bigint_key_signed`;
SELECT * FROM table_10_binary_undef WHERE  ( `col_char(20)_undef_signed` != ( ( 2 > `col_float_key_unsigned` ) % `col_bigint_undef_unsigned` ) );
SELECT `col_double_key_signed` FROM table_10_binary_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_10_binary_6 AS t1 JOIN table_10_utf8_4 AS t2 ON t1. `col_double_undef_signed` DIV t2. `col_char(20)_key_signed`;
SELECT * FROM table_10_latin1_4 WHERE NOT `col_decimal(40, 20)_key_unsigned`;
SELECT * FROM table_10_binary_6 WHERE  CONVERT(`col_varchar(20)_key_signed`, BINARY);
SELECT * FROM table_30_binary_4 AS t1 JOIN table_30_utf8_4 AS t2 ON t1. `col_decimal(40, 20)_key_signed` / t2. `col_bigint_undef_unsigned`;
SELECT * FROM table_10_utf8_4 WHERE NOT LCASE( 7 );
SELECT `col_double_key_signed` FROM table_10_utf8_undef WHERE ( `col_double_key_signed` );
SELECT * FROM table_30_latin1_4 WHERE  HEX( `col_double_key_signed` );
SELECT * FROM table_10_binary_6 AS t1 JOIN table_10_binary_undef AS t2 ON t1. `col_decimal(40, 20)_undef_unsigned` - t2. `col_char(20)_undef_signed`;
SELECT * FROM table_30_binary_6 AS t1 JOIN table_30_latin1_undef AS t2 ON t1. `col_decimal(40, 20)_key_signed` MOD t2. `col_bigint_undef_unsigned`;
SELECT `col_double_key_signed` FROM table_30_binary_4 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_binary_6 AS t1 JOIN table_30_binary_undef AS t2 ON t1. `col_varchar(20)_undef_signed` > t2. `col_float_key_unsigned`;
SELECT * FROM table_10_latin1_4 AS t1 JOIN table_10_utf8_4 AS t2 ON t1. `col_float_key_signed` + t2. `col_varchar(20)_key_signed`;
SELECT * FROM table_30_latin1_6 AS t1 JOIN table_30_binary_4 AS t2 ON t1. `col_decimal(40, 20)_key_signed` DIV t2. `col_char(20)_key_signed`;
SELECT * FROM table_10_utf8_undef AS t1 JOIN table_30_latin1_undef AS t2 ON t1. `col_float_key_unsigned` DIV t2. `col_bigint_key_unsigned`;
SELECT * FROM table_10_binary_undef HAVING  BINARY 3;
SELECT * FROM table_10_utf8_undef WHERE  BINARY `col_char(20)_key_signed`;
SELECT `col_double_key_signed` FROM table_30_latin1_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_binary_6 WHERE  ISNULL( ( `col_bigint_undef_unsigned` % 6 ) );
SELECT `col_double_key_signed` FROM table_30_latin1_undef HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_binary_4 WHERE NOT FORMAT( `col_bigint_undef_unsigned`, `col_decimal(40, 20)_undef_unsigned` );
SELECT * FROM table_30_binary_undef AS t1 JOIN table_30_binary_4 AS t2 ON t1. `col_char(20)_undef_signed` >= t2. `col_float_key_unsigned`;
SELECT * FROM table_10_utf8_4 WHERE  1;
SELECT `col_double_key_signed` FROM table_30_utf8_undef WHERE ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_latin1_6 WHERE ( `col_double_key_signed` );
SELECT * FROM table_30_latin1_undef AS t1 JOIN table_10_latin1_undef AS t2 ON t1. `col_decimal(40, 20)_undef_unsigned` % t2. `col_char(20)_key_signed`;
SELECT * FROM table_30_latin1_6 AS t1 JOIN table_10_latin1_4 AS t2 ON t1. `col_double_key_unsigned` + t2. `col_char(20)_undef_signed`;
SELECT * FROM table_10_binary_6 AS t1 JOIN table_10_utf8_4 AS t2 ON t1. `col_float_undef_signed` <= t2. `col_double_key_signed`;
SELECT `col_double_key_signed` FROM table_30_utf8_6 HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_binary_6 AS t1 JOIN table_30_latin1_undef AS t2 ON t1. `col_float_undef_unsigned` < t2. `col_float_undef_unsigned`;
SELECT * FROM table_30_latin1_undef HAVING  `col_float_key_unsigned`;
SELECT * FROM table_30_utf8_4 AS t1 JOIN table_30_utf8_4 AS t2 ON t1. `col_double_undef_unsigned` != t2. `col_bigint_key_unsigned`;
SELECT * FROM table_30_latin1_6 AS t1 JOIN table_30_latin1_undef AS t2 ON t1. `col_varchar(20)_key_signed` >= t2. `col_varchar(20)_key_signed`;
SELECT * FROM table_30_binary_6 AS t1 JOIN table_10_latin1_undef AS t2 ON t1. `col_varchar(20)_key_signed` - t2. `col_bigint_undef_signed`;
SELECT * FROM table_30_utf8_undef WHERE  STRCMP( ( ( ( 2 >= 5 ) <= ( ( 5 > 7 ) < `col_varchar(20)_undef_signed` ) ) <= ( ( 6 < ( `col_decimal(40, 20)_key_unsigned` > `col_double_key_signed` ) ) / ( 9 % `col_varchar(20)_undef_signed` ) ) ), `col_decimal(40, 20)_undef_unsigned` );
SELECT `col_double_key_signed` FROM table_30_binary_6 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_10_binary_undef WHERE ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_10_latin1_undef WHERE ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_binary_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_utf8_4 HAVING NOT CONVERT(5, SIGNED);
SELECT * FROM table_30_utf8_undef WHERE  WEEKOFYEAR( ( `col_float_undef_signed` + 1 ) );
SELECT * FROM table_30_binary_undef AS t1 JOIN table_10_binary_6 AS t2 ON t1. `col_decimal(40, 20)_undef_signed` <= t2. `col_float_key_unsigned`;
SELECT * FROM table_30_binary_undef HAVING NOT LOCALTIMESTAMP();
SELECT `col_double_key_signed` FROM table_30_binary_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_latin1_4 AS t1 JOIN table_30_utf8_4 AS t2 ON t1. `col_decimal(40, 20)_undef_unsigned` + t2. `col_double_undef_signed`;
SELECT `col_double_key_signed` FROM table_10_binary_4 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_latin1_undef HAVING NOT 7;
SELECT * FROM table_10_binary_4 AS t1 JOIN table_10_latin1_4 AS t2 ON t1. `col_varchar(20)_key_signed` + t2. `col_decimal(40, 20)_undef_unsigned`;
SELECT * FROM table_30_utf8_4 WHERE NOT ( `col_float_undef_signed` + `col_varchar(20)_key_signed` );
SELECT `col_double_key_signed` FROM table_30_utf8_6 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_binary_undef HAVING ( `col_double_key_signed` );
SELECT * FROM table_10_binary_undef AS t1 JOIN table_10_utf8_undef AS t2 ON t1. `col_decimal(40, 20)_undef_unsigned` = t2. `col_bigint_key_signed`;
SELECT * FROM table_30_utf8_4 WHERE  ( ( 3 DIV `col_double_undef_unsigned` ) DIV 0 );
SELECT * FROM table_30_binary_4 AS t1 JOIN table_30_utf8_undef AS t2 ON t1. `col_bigint_key_unsigned` * t2. `col_decimal(40, 20)_undef_unsigned`;
SELECT * FROM table_10_binary_6 AS t1 JOIN table_10_latin1_6 AS t2 ON t1. `col_bigint_key_unsigned` % t2. `col_bigint_undef_unsigned`;
SELECT `col_double_key_signed` FROM table_30_binary_6 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_latin1_6 HAVING NOT ( 7 MOD ( ( `col_float_undef_signed` MOD 1 ) = 6 ) );
SELECT `col_double_key_signed` FROM table_30_latin1_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_10_binary_6 AS t1 JOIN table_30_utf8_6 AS t2 ON t1. `col_decimal(40, 20)_key_signed` >= t2. `col_decimal(40, 20)_undef_signed`;
SELECT * FROM table_30_utf8_4 AS t1 JOIN table_30_utf8_6 AS t2 ON t1. `col_float_undef_signed` = t2. `col_double_key_signed`;
SELECT `col_double_key_signed` FROM table_10_utf8_undef WHERE ( `col_double_key_signed` );
SELECT * FROM table_30_latin1_6 AS t1 JOIN table_10_binary_4 AS t2 ON t1. `col_bigint_undef_unsigned` = t2. `col_bigint_key_signed`;
SELECT * FROM table_10_binary_4 WHERE NOT SIN ( `col_decimal(40, 20)_key_signed` );
SELECT * FROM table_10_binary_undef HAVING  BINARY `col_decimal(40, 20)_undef_signed`;
SELECT `col_double_key_signed` FROM table_30_binary_6 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_latin1_6 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_utf8_4 AS t1 JOIN table_30_latin1_6 AS t2 ON t1. `col_double_key_signed` >= t2. `col_bigint_key_unsigned`;
SELECT * FROM table_10_latin1_undef AS t1 JOIN table_10_binary_undef AS t2 ON t1. `col_float_key_signed` != t2. `col_decimal(40, 20)_undef_signed`;
SELECT * FROM table_10_latin1_undef WHERE NOT TAN ( ( `col_float_undef_unsigned` - 9 ) );
SELECT `col_double_key_signed` FROM table_30_utf8_undef HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_binary_6 WHERE NOT `col_double_undef_unsigned`;
SELECT `col_double_key_signed` FROM table_30_utf8_6 WHERE ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_utf8_4 WHERE ( `col_double_key_signed` );
SELECT * FROM table_30_utf8_6 WHERE NOT ( `col_char(20)_undef_signed` MOD 3 );
SELECT * FROM table_10_latin1_4 HAVING NOT ( `col_char(20)_undef_signed` < `col_float_key_unsigned` );
SELECT `col_double_key_signed` FROM table_30_binary_4 HAVING ( `col_double_key_signed` );
SELECT * FROM table_30_binary_4 WHERE NOT 7;
SELECT `col_double_key_signed` FROM table_10_binary_6 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_binary_undef HAVING ( `col_double_key_signed` );
SELECT * FROM table_10_latin1_undef HAVING  9;
SELECT `col_double_key_signed` FROM table_10_utf8_undef HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_utf8_4 WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_binary_4 WHERE  IFNULL( 0, `col_double_undef_unsigned` );
SELECT * FROM table_10_binary_6 WHERE NOT ( ( `col_char(20)_key_signed` > ( `col_double_key_unsigned` * 1 ) ) / ( `col_bigint_undef_signed` != 5 ) );
SELECT * FROM table_30_utf8_6 AS t1 JOIN table_30_latin1_6 AS t2 ON t1. `col_decimal(40, 20)_key_unsigned` % t2. `col_double_key_signed`;
SELECT * FROM table_30_binary_6 AS t1 JOIN table_10_binary_6 AS t2 ON t1. `col_float_key_unsigned` > t2. `col_varchar(20)_key_signed`;
SELECT * FROM table_10_binary_6 AS t1 JOIN table_10_binary_6 AS t2 ON t1. `col_decimal(40, 20)_key_signed` <= t2. `col_bigint_undef_unsigned`;
SELECT * FROM table_30_latin1_undef HAVING  5;
SELECT `col_double_key_signed` FROM table_30_binary_4 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_latin1_4 HAVING ( `col_double_key_signed` );
SELECT `col_double_key_signed` FROM table_30_latin1_undef WHERE ( `col_double_key_signed` );
SELECT * FROM table_10_binary_4 AS t1 JOIN table_30_utf8_6 AS t2 ON t1. `col_bigint_undef_signed` < t2. `col_float_key_signed`;