...
');
SELECT DENSE_RANK() OVER w1 AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN 0 PRECEDING AND UNBOUNDED PRECEDING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_double_key_signed` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING);
SELECT LEAD(fieldA, lag_para)  OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_float_undef_signed` AS fieldB FROM table_30_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN 0 FOLLOWING AND 1250951168 FOLLOWING);
SELECT NTILE(2) OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND 2 PRECEDING) AS 'ntile', fieldA, fieldB FROM ( SELECT `col_bigint_key_signed` AS fieldA, `col_bigint_undef_signed` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND 1 FOLLOWING);
SELECT FIRST_VALUE(fieldA) IGNORE NULLS OVER w1 AS 'first_value', fieldA, fieldB FROM ( SELECT `col_double_undef_unsigned` AS fieldA, `col_decimal(40, 20)_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN UNBOUNDED FOLLOWING AND 11 PRECEDING);
SELECT RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN 1250951168 FOLLOWING AND 0 PRECEDING) AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_10_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE UNBOUNDED PRECEDING);
SELECT FIRST_VALUE(fieldA) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS UNBOUNDED FOLLOWING) AS 'first_value', fieldA, fieldB FROM ( SELECT `col_bigint_key_signed` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED PRECEDING);
SELECT LEAD(fieldA, lag_para)  OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_10_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING);
SELECT LAG(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lag', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS BETWEEN -1 FOLLOWING AND CURRENT ROW);
SELECT ROW_NUMBER() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS CURRENT ROW) AS 'row_number', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE 11 FOLLOWING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS UNBOUNDED FOLLOWING) AS 'lead', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_varchar(20)_key_signed` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND -1 PRECEDING);
SELECT LAG(fieldA, lag_para) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND 91 PRECEDING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_decimal(40, 20)_key_signed` AS fieldB FROM table_30_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS UNBOUNDED FOLLOWING);
SELECT NTH_VALUE(fieldA, 1)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS UNBOUNDED PRECEDING) AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_char(20)_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS BETWEEN CURRENT ROW AND CURRENT ROW);
SELECT LAST_VALUE(fieldA)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS BETWEEN 11 PRECEDING AND 1 PRECEDING) AS 'last_value', fieldA, fieldB FROM ( SELECT `col_varchar(20)_undef_signed` AS fieldA, `col_double_key_signed` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE UNBOUNDED FOLLOWING);
SELECT NTH_VALUE(fieldA, 0) RESPECT NULLS OVER w1 AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_bigint_key_signed` AS fieldA, `col_decimal(40, 20)_undef_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE CURRENT ROW);
SELECT NTILE(2) OVER w1 AS 'ntile', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER w1 AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_undef_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS UNBOUNDED PRECEDING);
SELECT LAST_VALUE(fieldA)  OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_double_undef_unsigned` AS fieldA, `col_varchar(20)_undef_signed` AS fieldB FROM table_10_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE 0 PRECEDING);
SELECT LEAD(fieldA, lag_para) IGNORE NULLS OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_unsigned` AS fieldA, `col_decimal(40, 20)_undef_signed` AS fieldB FROM table_10_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS BETWEEN 2 PRECEDING AND 91 PRECEDING);
SELECT DENSE_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN 1 PRECEDING AND UNBOUNDED PRECEDING) AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN 1250951168 FOLLOWING AND UNBOUNDED PRECEDING);
SELECT NTILE(2) OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE BETWEEN CURRENT ROW AND 91 FOLLOWING) AS 'ntile', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_signed` AS fieldA, `col_char(20)_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN 11 FOLLOWING AND UNBOUNDED FOLLOWING);
SELECT RANK() OVER w1 AS 'rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS BETWEEN CURRENT ROW AND 0 PRECEDING);
SELECT RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN UNBOUNDED FOLLOWING AND 11 PRECEDING) AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_undef_signed` AS fieldA, `col_decimal(40, 20)_undef_unsigned` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE BETWEEN CURRENT ROW AND 2 PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_30_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS BETWEEN UNBOUNDED FOLLOWING AND 1 FOLLOWING);
SELECT RANK() OVER w1 AS 'rank', fieldA, fieldB FROM ( SELECT `col_bigint_undef_unsigned` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING);
SELECT ROW_NUMBER() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS 'row_number', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND 1250951168 FOLLOWING);
SELECT ROW_NUMBER() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED FOLLOWING AND UNBOUNDED PRECEDING) AS 'row_number', fieldA, fieldB FROM ( SELECT `col_double_key_unsigned` AS fieldA, `col_char(20)_key_signed` AS fieldB FROM table_10_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS 91 PRECEDING);
SELECT FIRST_VALUE(fieldA) RESPECT NULLS OVER w1 AS 'first_value', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_double_undef_signed` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE 2 PRECEDING);
SELECT RANK() OVER w1 AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE 1250951168 PRECEDING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_decimal(40, 20)_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS UNBOUNDED FOLLOWING);
SELECT LAST_VALUE(fieldA)  OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS BETWEEN -1 FOLLOWING AND 11 FOLLOWING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_char(20)_undef_signed` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_10_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED FOLLOWING AND -1 PRECEDING);
SELECT LAG(fieldA, lag_para) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED PRECEDING AND -1 FOLLOWING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_float_undef_signed` AS fieldA, `col_double_key_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS BETWEEN 2 FOLLOWING AND CURRENT ROW);
SELECT LAG(fieldA, lag_para)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS UNBOUNDED PRECEDING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_varchar(20)_undef_signed` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS 91 FOLLOWING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_varchar(20)_undef_signed` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE UNBOUNDED FOLLOWING);
SELECT DENSE_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE UNBOUNDED FOLLOWING) AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_unsigned` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN 91 PRECEDING AND 2 PRECEDING);
SELECT CUME_DIST() OVER w1 AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE BETWEEN CURRENT ROW AND 2 PRECEDING);
SELECT PERCENT_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE CURRENT ROW) AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_varchar(20)_key_signed` AS fieldB FROM table_30_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING);
SELECT LAST_VALUE(fieldA)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE 91 PRECEDING) AS 'last_value', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_varchar(20)_key_signed` AS fieldB FROM table_10_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE UNBOUNDED PRECEDING);
SELECT LAG(fieldA, lag_para) IGNORE NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE BETWEEN 2 PRECEDING AND -1 FOLLOWING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_30_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS BETWEEN 11 PRECEDING AND UNBOUNDED PRECEDING);
SELECT FIRST_VALUE(fieldA) RESPECT NULLS OVER w1 AS 'first_value', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING);
SELECT NTH_VALUE(fieldA, 91) IGNORE NULLS OVER w1 AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_float_key_signed` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE CURRENT ROW);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN 0 PRECEDING AND UNBOUNDED PRECEDING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_double_undef_unsigned` AS fieldA, `col_varchar(20)_undef_signed` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE UNBOUNDED PRECEDING);
SELECT FIRST_VALUE(fieldA)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN 1250951168 FOLLOWING AND 91 PRECEDING) AS 'first_value', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_signed` AS fieldA, `col_decimal(40, 20)_key_signed` AS fieldB FROM table_10_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED PRECEDING AND 1250951168 PRECEDING);
SELECT ROW_NUMBER() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND 1250951168 PRECEDING) AS 'row_number', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_decimal(40, 20)_undef_unsigned` AS fieldB FROM table_30_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE UNBOUNDED FOLLOWING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_float_undef_signed` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS BETWEEN 1250951168 FOLLOWING AND UNBOUNDED FOLLOWING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE CURRENT ROW) AS 'lead', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS UNBOUNDED FOLLOWING);
SELECT RANK() OVER w1 AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS UNBOUNDED PRECEDING);
SELECT NTILE(11) OVER w1 AS 'ntile', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_signed` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE UNBOUNDED FOLLOWING);
SELECT NTILE(1) OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS 'ntile', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_10_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN CURRENT ROW AND -1 PRECEDING);
SELECT NTILE(-1) OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING) AS 'ntile', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_float_key_signed` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS UNBOUNDED FOLLOWING);
SELECT ROW_NUMBER() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN 1250951168 PRECEDING AND CURRENT ROW) AS 'row_number', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_decimal(40, 20)_undef_unsigned` AS fieldB FROM table_30_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN CURRENT ROW AND UNBOUNDED PRECEDING);
SELECT RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE BETWEEN 1 PRECEDING AND UNBOUNDED FOLLOWING) AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_undef_signed` AS fieldA, `col_varchar(20)_key_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND 11 FOLLOWING);
SELECT LAG(fieldA, lag_para)  OVER w1 AS 'lag', fieldA, fieldB FROM ( SELECT `col_double_undef_unsigned` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE UNBOUNDED PRECEDING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_30_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS CURRENT ROW) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_10_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE 1 PRECEDING);
SELECT LAG(fieldA, lag_para) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS UNBOUNDED FOLLOWING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING);
SELECT PERCENT_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED FOLLOWING AND UNBOUNDED PRECEDING) AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_10_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE BETWEEN 1 FOLLOWING AND UNBOUNDED PRECEDING);
SELECT LEAD(fieldA, lag_para) IGNORE NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS 91 FOLLOWING) AS 'lead', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_30_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN -1 FOLLOWING AND UNBOUNDED FOLLOWING);
SELECT NTILE(1) OVER w1 AS 'ntile', fieldA, fieldB FROM ( SELECT `col_bigint_key_signed` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS BETWEEN 1 PRECEDING AND 11 PRECEDING);
SELECT LAG(fieldA, lag_para)  OVER w1 AS 'lag', fieldA, fieldB FROM ( SELECT `col_double_key_unsigned` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE 0 PRECEDING);
SELECT NTILE(-1) OVER w1 AS 'ntile', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_bigint_undef_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS BETWEEN CURRENT ROW AND UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS BETWEEN CURRENT ROW AND 1250951168 FOLLOWING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS CURRENT ROW);
SELECT CUME_DIST() OVER w1 AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_float_undef_signed` AS fieldA, `col_double_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE CURRENT ROW);
SELECT LAST_VALUE(fieldA) RESPECT NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS BETWEEN UNBOUNDED FOLLOWING AND 1 FOLLOWING) AS 'last_value', fieldA, fieldB FROM ( SELECT `col_double_key_unsigned` AS fieldA, `col_decimal(40, 20)_key_signed` AS fieldB FROM table_30_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS CURRENT ROW) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_key_signed` AS fieldA, `col_decimal(40, 20)_undef_signed` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE -1 PRECEDING);
SELECT LAST_VALUE(fieldA) IGNORE NULLS OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_bigint_undef_signed` AS fieldA, `col_decimal(40, 20)_undef_signed` AS fieldB FROM table_30_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS BETWEEN CURRENT ROW AND UNBOUNDED PRECEDING);
SELECT LAST_VALUE(fieldA) IGNORE NULLS OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_bigint_undef_signed` AS fieldB FROM table_30_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE UNBOUNDED FOLLOWING);
SELECT PERCENT_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS UNBOUNDED FOLLOWING) AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_double_key_signed` AS fieldA, `col_bigint_key_unsigned` AS fieldB FROM table_10_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE UNBOUNDED FOLLOWING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_bigint_undef_signed` AS fieldA, `col_float_key_signed` AS fieldB FROM table_10_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS 0 PRECEDING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_bigint_undef_unsigned` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE UNBOUNDED PRECEDING);
SELECT PERCENT_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC RANGE -1 PRECEDING) AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_char(20)_undef_signed` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC ROWS UNBOUNDED FOLLOWING);
SELECT NTH_VALUE(fieldA, 1) IGNORE NULLS OVER w1 AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND UNBOUNDED PRECEDING);
SELECT NTH_VALUE(fieldA, 91) RESPECT NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS UNBOUNDED FOLLOWING) AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_char(20)_undef_signed` AS fieldA, `col_bigint_key_unsigned` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE 11 FOLLOWING);
SELECT NTH_VALUE(fieldA, 0)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN UNBOUNDED FOLLOWING AND UNBOUNDED FOLLOWING) AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_char(20)_undef_signed` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_30_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND 1250951168 FOLLOWING);
SELECT RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE UNBOUNDED FOLLOWING) AS 'rank', fieldA, fieldB FROM ( SELECT `col_float_key_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS CURRENT ROW);
SELECT RANK() OVER w1 AS 'rank', fieldA, fieldB FROM ( SELECT `col_bigint_undef_unsigned` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_30_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE UNBOUNDED FOLLOWING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_char(20)_undef_signed` AS fieldA, `col_float_undef_unsigned` AS fieldB FROM table_10_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS BETWEEN 0 FOLLOWING AND UNBOUNDED FOLLOWING);
SELECT LAG(fieldA, lag_para) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE 1 PRECEDING) AS 'lag', fieldA, fieldB FROM ( SELECT `col_double_key_signed` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW);
SELECT NTILE(-1) OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS BETWEEN CURRENT ROW AND 0 PRECEDING) AS 'ntile', fieldA, fieldB FROM ( SELECT `col_char(20)_key_signed` AS fieldA, `col_double_key_unsigned` AS fieldB FROM table_30_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE BETWEEN UNBOUNDED PRECEDING AND 2 PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE 91 FOLLOWING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_undef_signed` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC ROWS BETWEEN 1250951168 FOLLOWING AND UNBOUNDED PRECEDING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS UNBOUNDED FOLLOWING) AS 'lead', fieldA, fieldB FROM ( SELECT `col_double_undef_unsigned` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS BETWEEN UNBOUNDED FOLLOWING AND CURRENT ROW);
SELECT DENSE_RANK() OVER w1 AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_char(20)_undef_signed` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC RANGE 0 PRECEDING);
SELECT DENSE_RANK() OVER w1 AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_double_undef_unsigned` AS fieldB FROM table_10_binary_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN CURRENT ROW AND CURRENT ROW);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_key_signed` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC RANGE CURRENT ROW);
SELECT DENSE_RANK() OVER w1 AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_varchar(20)_key_signed` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE UNBOUNDED PRECEDING);
SELECT LAG(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lag', fieldA, fieldB FROM ( SELECT `col_double_key_signed` AS fieldA, `col_double_undef_signed` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND -1 PRECEDING);
SELECT NTH_VALUE(fieldA, 0) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) ASC ROWS BETWEEN CURRENT ROW AND UNBOUNDED PRECEDING) AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_bigint_undef_signed` AS fieldA, `col_float_key_signed` AS fieldB FROM table_30_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE UNBOUNDED FOLLOWING);
SELECT PERCENT_RANK() OVER w1 AS 'percent_rank', fieldA, fieldB FROM ( SELECT `col_float_key_signed` AS fieldA, `col_bigint_undef_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS UNBOUNDED FOLLOWING);
SELECT FIRST_VALUE(fieldA) IGNORE NULLS OVER (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS 2 FOLLOWING) AS 'first_value', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_bigint_undef_unsigned` AS fieldB FROM table_30_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC ROWS CURRENT ROW);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN 11 PRECEDING AND UNBOUNDED PRECEDING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_undef_signed` AS fieldA, `col_varchar(20)_undef_signed` AS fieldB FROM table_10_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS CURRENT ROW);
SELECT LAST_VALUE(fieldA) IGNORE NULLS OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_varchar(20)_key_signed` AS fieldA, `col_float_key_signed` AS fieldB FROM table_10_utf8_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING);
SELECT LEAD(fieldA, lag_para)  OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE -1 PRECEDING) AS 'lead', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_30_utf8_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) ASC RANGE BETWEEN CURRENT ROW AND UNBOUNDED FOLLOWING);
SELECT DENSE_RANK() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) DESC RANGE UNBOUNDED FOLLOWING) AS 'dense_rank', fieldA, fieldB FROM ( SELECT `col_float_undef_signed` AS fieldA, `col_decimal(40, 20)_key_unsigned` AS fieldB FROM table_10_latin1_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) DESC RANGE BETWEEN UNBOUNDED PRECEDING AND 11 FOLLOWING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_unsigned` AS fieldA, `col_bigint_key_signed` AS fieldB FROM table_10_latin1_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) DESC , LOWER(fieldB) ASC RANGE BETWEEN -1 PRECEDING AND 91 PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN 91 PRECEDING AND CURRENT ROW) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_bigint_key_unsigned` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_30_utf8_6 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE BETWEEN CURRENT ROW AND UNBOUNDED PRECEDING);
SELECT LEAD(fieldA, lag_para) RESPECT NULLS OVER w1 AS 'lead', fieldA, fieldB FROM ( SELECT `col_decimal(40, 20)_undef_signed` AS fieldA, `col_float_key_unsigned` AS fieldB FROM table_10_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldA) ASC , LOWER(fieldB) ASC ROWS UNBOUNDED PRECEDING);
SELECT CUME_DIST() OVER (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS BETWEEN 91 FOLLOWING AND UNBOUNDED PRECEDING) AS 'cume_dist', fieldA, fieldB FROM ( SELECT `col_double_undef_signed` AS fieldA, `col_double_undef_signed` AS fieldB FROM table_10_latin1_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (w1 PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC RANGE -1 FOLLOWING);
SELECT NTH_VALUE(fieldA, 2)  OVER w1 AS 'nth_value', fieldA, fieldB FROM ( SELECT `col_bigint_undef_unsigned` AS fieldA, `col_bigint_key_unsigned` AS fieldB FROM table_10_binary_4 ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) ASC , LOWER(fieldA) DESC ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED PRECEDING);
SELECT LAST_VALUE(fieldA) RESPECT NULLS OVER w1 AS 'last_value', fieldA, fieldB FROM ( SELECT `col_float_undef_unsigned` AS fieldA, `col_double_key_signed` AS fieldB FROM table_10_binary_undef ORDER BY LOWER(fieldA), LOWER(fieldB) ) as t WINDOW w1 AS (PARTITION BY LOWER(fieldB) ORDER BY LOWER(fieldB) DESC , LOWER(fieldA) DESC ROWS UNBOUNDED FOLLOWING);